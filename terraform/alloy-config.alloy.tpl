...
discovery.relabel "node_exporter_journal" {
  targets = []
...
local.file_match "node_exporter_direct" {
  path_targets = [{
...
loki.source.file "node_exporter_direct" {
  targets    = local.file_match.node_exporter_direct.targets
  forward_to = [loki.write.grafana_cloud_loki.receiver]
}
